...
<?php
add_javascript('<script src="'.G5_JS_URL.'/jquery.min.js"></script>', 0);
if (defined('_SHOP_')) {
    if(!G5_IS_MOBILE) {
...
add_javascript('<script src="'.G5_JS_URL.'/global.js"></script>', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/css/common.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/css/global.css">', 0);
