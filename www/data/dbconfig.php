...
define('G5_MYSQL_USER', 'seaever');
define('G5_MYSQL_PASSWORD', 'tldpqj4939!@');
define('G5_MYSQL_DB', 'seaever');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '55256c27ced4ca94feaacfa656ba143b'); // 토큰 암호화에 사용할 키
